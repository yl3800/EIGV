...
parser.add_argument("-epoch", type=int, action="store", help="epoch for train", default=70)
...
parser.add_argument("-a", type=float, help="alpha", default=2)
parser.add_argument("-a2", type=float, help="alpha2", default=2)
