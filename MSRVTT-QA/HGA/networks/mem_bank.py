...
class MemBank(nn.Module):
    def __init__(self, mot_feat):
        super().__init__()
        if mot_feat=='resnext':
            bank_path='/storage_fast/ycli/vqa/mem_bank/msrvtt/msrvtt-res152-resnext.h5'
        elif mot_feat=='3dres152':
            bank_path='/storage_fast/ycli/vqa/mem_bank/msrvtt/msrvtt-res152-3dres152.h5'
        else:
            raise ValueError('motion feat should be resnext or 3dres152')
